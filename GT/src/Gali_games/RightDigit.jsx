...
function RightDigit() {
  ...
  return (
    <>
      <div className="font-bold flex items-center justify-center text-2xl mt-2"><h1>Right Digit</h1></div>
    ...
    <option key={index} value={digit} />
            ...
            <div className="flex  mb-4 text-white">
              ...
              {isProceed && (
                  <>
                    <button
                      className="p-4 border border-black-500 rounded-xl bg-yellow-600 hover:bg-yellow-500 cursor-pointer text-black mt-4 w-full ml-3"
            ...
            {submittedData.map((data, index) => {
              ...
              return (
                <div key={index} className="w-full flex mb-3 ">
                  ...
                  <button
                    className="shadow-md bg-white p-4 flex items-center justify-center ml-1"
