...
function LeftDigit() {
  ...
  return (
    <>
      <div className="font-bold flex items-center justify-center text-2xl mt-2"><h1>Left Digit</h1></div>
        ...
        <div className="flex justify-center items-center pt-5 ">
          <div className="" style={cardStyle}>
            ...
            <input
              ...
              className="shadow-md w-full p-4 border-2 rounded-xl text-black bg-white"
  ...
  {singleDigitArray.map((digit, index) => (
    <option key={index} value={digit} />
            ...
            <input
              ...
              className="shadow-md w-full  p-4 border rounded-xl text-black bg-white"
            />
            <div className="flex  mb-4 text-white">
              <button
                className={`p-4 border-2 border-black-500 rounded-xl bg-yellow-600 hover:bg-yellow-500 cursor-pointer mt-4 ${
              ...
              {isProceed && (
                  <>
                    <button
                      className="p-4 border border-black-500 rounded-xl bg-yellow-600 hover:bg-yellow-500 cursor-pointer mt-4 w-full ml-3 text-black"
