...
function Stripplepana() {
  ...
  return (
    <>
      <div className="font-bold flex items-center justify-center text-2xl mt-2"><h1>Triple Pana</h1></div>
            ...
            {submittedData.map((data, index) => {
              ...
              return (
                <div key={index} className="w-full flex mb-3 ">
                  ...
                  <button
                    className="shadow-md borde bg-white p-4 flex items-center justify-center ml-1"
