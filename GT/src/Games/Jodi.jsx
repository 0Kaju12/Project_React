        ...
        <div className="flex justify-center items-center pt-5 ">
          <div className="" style={cardStyle}>
            ...
            <input
              ...
              className="w-full p-4 border shadow-md border-black-500 rounded-xl text-black"
            ...
            <input
              ...
              className="border shadow-md w-full  p-4 border-black-500 rounded-xl text-black"
            />
